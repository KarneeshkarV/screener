...
def main() -> None:
    ...
    if args.path == "rolling":
        specs = [
            (rolling, "_prepare_simulation", "prepare_simulation"),
            (rolling, "_precompute_entry_signals", "entry_signals"),
            (rolling, "_precompute_filter_signals", "filter_signals"),
            (rolling, "_build_rolling_candidate_matrices", "candidate_matrices"),
