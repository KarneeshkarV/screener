...
HISTORICAL_GOLDEN: dict[str, dict] = {
    "dividends": {
        ...
        "equity": [
            ...
            ["2024-01-22", 101902.135561],
            ["2024-01-23", 101902.135561],
            ["2024-01-24", 101902.135561],
            ["2024-01-25", 101902.135561],
            ["2024-01-26", 101902.135561],
        ],
    },
    "gap_fills": {
        "trades": [
    ...
    "partial_exits": {
        ...
        "equity": [
            ...
            ("2024-01-11", 101975.066443),
            ("2024-01-12", 101975.066443),
            ("2024-01-15", 101975.066443),
            ("2024-01-16", 101975.066443),
            ("2024-01-17", 101975.066443),
            ("2024-01-18", 101975.066443),
            ("2024-01-19", 101975.066443),
            ("2024-01-22", 101975.066443),
            ("2024-01-23", 101975.066443),
            ("2024-01-24", 101975.066443),
            ("2024-01-25", 101975.066443),
            ("2024-01-26", 101975.066443),
            ("2024-01-29", 101975.066443),
            ("2024-01-30", 101975.066443),
            ("2024-01-31", 101975.066443),
            ("2024-02-01", 101975.066443),
            ("2024-02-02", 101975.066443),
            ("2024-02-05", 101975.066443),
            ("2024-02-06", 101975.066443),
            ("2024-02-07", 101975.066443),
            ("2024-02-08", 101975.066443),
            ("2024-02-09", 101975.066443),
        ],
    },
    "reserve_promotion": {
        "trades": [
    ...
    "slippage_commission": {
        ...
        "equity": [
            ...
            ["2024-01-16", 99022.953647],
            ["2024-01-17", 99022.953647],
            ["2024-01-18", 99022.953647],
            ["2024-01-19", 99022.953647],
            ["2024-01-22", 99022.953647],
            ["2024-01-23", 99022.953647],
            ["2024-01-24", 99022.953647],
            ["2024-01-25", 99022.953647],
            ["2024-01-26", 99022.953647],
        ],
    },
    "trailing_stop": {
        "trades": [
